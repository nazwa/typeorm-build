...
var PostgresQueryRunner = /** @class */ (function (_super) {
    ...
    PostgresQueryRunner.prototype.getEnumTypeName = function (table, column) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var currentSchemaQuery, currentSchema, _a, schema, name, result, udtName, typeResult, typelem, baseTypeNameResult, baseTypeName;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.query("SELECT * FROM current_schema()")];
                    case 1:
                    ...
                    case 2:
                        ...
                        if (!column.isArray) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.query("SELECT \"typelem\" FROM pg_type WHERE \"typname\" = $1", [udtName])];
                    case 3:
                        typeResult = _b.sent();
                        typelem = typeResult[0]["typelem"];
                        return [4 /*yield*/, this.query("SELECT \"typname\" FROM pg_type WHERE oid = $1", [typelem])];
                    case 4:
                        baseTypeNameResult = _b.sent();
                        baseTypeName = baseTypeNameResult[0]["typname"];
